...
function bubblesort (unsortAry){
  for (var j=unsortAry.length; j>=1; j-- ) {

    for (var i=0; i<=j; i++){
      if (unsortAry[i]>unsortAry[i+1]){
          var tempNum = unsortAry[i];
          unsortAry[i] = unsortAry[i+1];
          unsortAry[i+1] = tempNum;
      }
    }
  }
...
var unsortedArr1 = [1,9,2,5,8,6,7,3,4,11,20,12,15];
var unsortedArr2 = ['a','c','b'];
console.log(unsortedArr1);
console.log(unsortedArr2);
var sortedArr1 = bubblesort (unsortedArr1);
console.log(sortedArr1);


var sortedArr2 = bubblesort (unsortedArr2);
console.log(sortedArr2);
///////////////////////////////////////////////

const sortArray = function (unsortAry){


  if (Array.isArray(unsortAry)){
    for (var j=unsortAry.length; j>=1; j-- ) {
...
// const sortedArr1 = bubblesort (unsortedArr1);

// console.log(sortedArr1);



// var unsortArrayDisplay = document.getElementById("start");
// // unsortArrayDisplay.innerHTML = unsortedArr1;


// var selectGo = document.getElementById("go");

// selectGo.onclick = function(){
// bubblesort(unsortedArr1);
// console.log(unsortedArr1);
// var sortArrayDisplay = document.getElementById("result");
// sortArrayDisplay.innerHTML = unsortedArr1;
// }
...
// var unsortArrayDisplay = document.getElementById("start");
// unsortArrayDisplay.innerHTML = unsortedArr;
...
// var sortArrayDisplay = document.getElementById("result");
// sortArrayDisplay.innerHTML = unsortedArr;
// }
